import requests
from config import Q_C_API_KEY, CROWDSTRIKE_API_URL
from requests.exceptions import HTTPError, Timeout, RequestException

def get_host_from_crowdstrikes(api_key: str = Q_C_API_KEY) -> list:
    headers = {
    ...
    try:
        ...
        res = requests.post(CROWDSTRIKE_API_URL, headers=headers, timeout=15)
